 ...
 * [lsdao.yml](lsdao.yml)
     * Determines how your purl.obolibrary.org/obo/lsdao/ redirects will be handled
     ...
     * Paste in the contents of [lsdao.yml](lsdao.yml)
 ...
 * [lsdao.md](lsdao.md)
     ...
     * Paste in the contents of [lsdao.md](lsdao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
